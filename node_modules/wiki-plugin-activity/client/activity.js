        ...
        for (i = n = 0, len4 = sites.length; n < len4; i = ++n) {
          ...
          if (i < 10) {
            ...
            flags.unshift(h('img.remote', {
              title: "".concat(each.site, "\n").concat(wiki.util.formatElapsedTime(each.page.date)),
              src: "".concat(wiki.site(each.site).flag()),
              attributes: {
                "data-site": each.site,
        ...
        if (!(query.mine === "no" && site === location.host)) {
          ...
          for (k = 0, len1 = ref.length; k < len1; k++) {
            ...
            if (_.findIndex(sites, ['site', site]) === -1) {
              ...
              sites[_.findIndex(sites, ['site', site])] = {
                site: site,
                page: {
                  slug: each.slug,
                  title: each.title,
